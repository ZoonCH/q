...
/*exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Subscribe', body: wm, sourceUrl: 'https://youtube.com/channel/UCjzlh0Uhz8KJYZnZ0BVN35w', thumbnail: data }}, options })
    }
    m.name = m.pushName || conn.getName(m.sender)
